...
const SAMPLE_QUESTIONS = [
  ...
  "Show revenue and net income for all tech companies in 2024",
  "Which companies grew revenue over 20% from 2023 to 2024?",
  "Rank companies within each sector by 2024 revenue",
  "Show the 7-day rolling average close price for NVIDIA",
  "Find high-debt, high-ROE companies in 2024",
  "Which analyst firms issued the most Strong Buy ratings?",
