  ...
  const handleQuery = async (question: string) => {
    ...
    try {
      ...
      setResult({
        ...
        rows: [],
        row_count: 0,
        error: "Failed to connect to the backend server. Please try again in a moment.",
        retries: 0,
        ...
        <main>
          <div className="bg-gray-900/40 border border-gray-800 rounded-2xl p-6">
            <p className="text-sm text-gray-400 mb-4">
              Type a question in plain English, get SQL + results + a chart back instantly.
            </p>
            ...
            {loading && (
              <div className="mt-6 flex items-center gap-3 text-gray-500">
                ...
                <span className="text-sm font-mono">Generating SQL with Gemini 2.5 Flash...</span>
              </div>
            )}
