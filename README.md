...
## Stack
- **Backend**: FastAPI + Python 3.11, SQLite, pandas, Anthropic SDK
- **Frontend**: Next.js 15, Tailwind CSS, Recharts
- **LLM**: Claude Sonnet 4.6 with 15 few-shot examples + schema injection + auto-retry
...
4. **Auto-retry loop** - if SQL fails, error + failed query are sent back to Claude for correction (up to 3 retries)
